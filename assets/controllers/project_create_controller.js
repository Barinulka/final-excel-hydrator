...
export default class extends Controller {
    ...
    async submit(event) {
        ...
        try {
            ...
            if (!response.ok) {
                this.showError(this.formErrorTarget, 'Не удалось создать проект.');
                return;
            }
            ...
            storePendingToast('Проект создан.');
    ...
    setSubmitting(isSubmitting) {
        ...
        this.submitTarget.textContent = isSubmitting ? 'Создаем...' : 'Создать проект';
    }
}
