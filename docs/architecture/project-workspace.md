# Project Workspace Frontend Strategy (черновик)

## Цель документа
Документ фиксирует UI/UX и frontend-стратегию для рабочей области проектов.

Это решение относится к Presentation Layer. Оно не меняет доменную модель и не переносит бизнес-логику во frontend.
